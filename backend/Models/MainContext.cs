    ...
    public class MainContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder) {
            ...
            modelBuilder.Entity<Training>().HasData(
                new Training {IdExperience = 1, Start = new DateTime(2022, 02, 1), Finish = new DateTime(2022, 06, 30),place="EPFC", Title = "Bachelore in computer science",Description ="", Role = ExperienceRole.TRAINING, Grade = 90},
                new Training {IdExperience = 2, Start = new DateTime(2021, 02, 1), Finish = new DateTime(2021, 06, 30), place="EPFC", Title = "Bachelore in computer science",Description ="", Role = ExperienceRole.TRAINING, Grade = 77}
            );
